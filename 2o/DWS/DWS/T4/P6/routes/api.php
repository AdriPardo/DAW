...
$dispatcher = FastRoute\simpleDispatcher(function(FastRoute\RouteCollector $r) {
    ...
    $r->addRoute('POST', $basedir . '/peliculas', 'Pelicula@insert');
    $r->addRoute('PUT', $basedir . '/peliculas/{id:\d+}', 'Pelicula@put');
    $r->addRoute('PATCH', $basedir . '/peliculas/{id:\d+}', 'Pelicula@patch');
    $r->addRoute('DELETE', $basedir . '/peliculas/{id:\d+}', 'Pelicula@delete');
